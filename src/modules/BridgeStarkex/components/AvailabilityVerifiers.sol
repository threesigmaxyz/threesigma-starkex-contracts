...
*/
abstract contract AvailabilityVerifiers is MainStorage, LibConstants , ApprovalChain{
  ...
  function registerAvailabilityVerifier(address verifier, string calldata identifier)  internal {
