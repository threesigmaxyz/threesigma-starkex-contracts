...
*/
abstract contract TokenRegister is MainStorage, LibConstants,  MTokenAssetData {
  ...
  function registerTokenAdmin(address newAdmin) internal{
    tokenAdmins[newAdmin] = true;
    emit LogTokenAdminAdded(newAdmin);
  }

  function unregisterTokenAdmin(address oldAdmin) internal {
  ...
  */
  ...
  function registerToken(uint256 assetType, bytes calldata assetInfo) internal {
